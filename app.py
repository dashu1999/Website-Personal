...
class Contacts(db.Model):
    ...
    email_model = db.Column(db.String(20), nullable=False)
...
@app.route("/")
def home():
    #flash("No Messege", "success")
    #flash("No dashu", "danger")
...
def contact():
    if(request.method=='POST'):
        ...
        entry = Contacts(name=name, phone_num = phone, msg = message, date= datetime.now(),email_model = email, )
